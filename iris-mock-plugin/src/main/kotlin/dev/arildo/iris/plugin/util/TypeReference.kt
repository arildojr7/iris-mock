...
import dev.arildo.iris.plugin.util.TypeReference.Descriptor
import dev.arildo.iris.plugin.util.TypeReference.Psi
...
public sealed class TypeReference {
    ...
    public class Psi internal constructor(
        ...
        private fun KtTypeReference.requireTypeName(): TypeName {
            fun PsiElement.fail(): Nothing = throw Exception( "Couldn't resolve type: $text")
