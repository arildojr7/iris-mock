...
public sealed class ClassReference : Comparable<ClassReference>, AnnotatedReference {
    ...
    public class Psi(
        ...
        override val properties: List<MemberPropertyReference.Psi>
            get() = mutableListOf<MemberPropertyReference.Psi>().apply {
        ...
        override fun visibility(): Visibility {
            return when (val visibility = clazz.visibilityModifierTypeOrDefault()) {
                ...
                INTERNAL_KEYWORD -> Visibility.INTERNAL
                PROTECTED_KEYWORD -> Visibility.PROTECTED
                PRIVATE_KEYWORD -> Visibility.PRIVATE
                else -> throw Exception("Couldn't get visibility $visibility for class $fqName.")
            }
        }
    ...
    public class Descriptor(
        ...
        override val typeParameters: List<TypeParameterReference.Descriptor>
            get() = clazz.declaredTypeParameters
                .map { typeParameter ->
